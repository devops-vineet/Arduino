...
void playAnnouncement(int hour) {
  // Define the array of Hindi numbers
  char* hindiNumbers[] = {"शून्य", "एक", "दो", "तीन", "चार", "पांच", "छह", "सात", "आठ", "नौ", "दस", "ग्यारह", "बारह"};

  // Convert the hour to a string
  String hourString = hindiNumbers[hour];

  // Build the announcement string
  String announcement = "अब समय है " + hourString + " बजे.";
